      ...
      <Card.Body>
        ...
        <Row className="mb-3">
          <Form.Group as={Col} controlId='formBasicAddress'>
            ...
            <Form.Control type='address' placeholder='Enter Street Address' value={props.address}
              onChange={(e) => props.handleCallBackAddress(e.target.value)} />
          </Form.Group>

          <Form.Group as={Col} controlId='formBasicState'>
            <Form.Label>State</Form.Label>
            <Form.Control type='state' placeholder='Enter State' value={props.state}
          ...
          <Form.Group as={Col} controlId='formBasicCity'>
            ...
            <Form.Control type='city' placeholder='Enter City' value={props.city}
          ...
          <Form.Group as={Col} controlId='formBasicZip'>
            ...
            <Form.Control type='zip' placeholder='Enter Zip/post Code' value={props.zip}
          ...
          <Form.Group as={Col} controlId='formBasicSQFT'>
            ...
            <Form.Control type='squareFeet' placeholder='Enter Home Square Feet ' value={props.squareFeet}
              onChange={(e) => props.handleCallBackSquareFeet(e.target.value)} />
          </Form.Group>

          <Form.Group as={Col} controlId='formBasicBedroom'>
            <Form.Label>Number of Bedrooms</Form.Label>
            <Form.Control type='bedroom' placeholder='Enter # of Bedrooms in home' value={props.bedroom}
          ...
          <Form.Group as={Col} controlId='formBasicBathroom'>
            ...
            <Form.Control type='bathroom' placeholder='Enter # of Bathrooms in home' value={props.bathroom}
          ...
          <Form.Group className='mb-3' controlId='formBasicPrice'>
            ...
            <Form.Control type='price' placeholder='Enter desired listing price' value={props.price}
          ...
          <Form.Group className='mb-3' controlId='formBasicAmenities'>
            ...
            <Form.Control type='amenities' placeholder='Enter other house ameniies' value={props.amenities}
              onChange={(e) => props.handleCallBackAmenities(e.target.value)} />
          </Form.Group>

          <Form.Group controlId="formFileMultiple" className="mb-3">
          <Form.Label>Upload Images</Form.Label>
          <Form.Control type="file" multiple value={props.file}
              onChange={(e) => props.handleCallBackFile(e.target.value)}/>
          </Form.Group>
          <br />
          <br />
          <Button variant='primary' type='submit' onClick={(e) => props.handleCallBackSubmit()}>  
            List
          </Button>
        </Form>
      </Card.Body>
